...
const planPromptWithOpenAI = async ({
  ...
  const system = [
    ...
    'Keep content safe-for-work: no nudity or sexual content, no real-person sexual or degrading depictions, no graphic violence, no hate speech targeting protected groups. Absurdist, exaggerated, and satirical humor about public figures and situations is fine as long as it stays non-sexual and non-defamatory.',
  ].join(' ');
...
const compilePromptFromPlan = ({
  ...
  return [
    ...
    'Playful absurdity is encouraged; keep humor non-sexual, non-graphic, and free of real-person defamation.',
  ]
    .filter(Boolean)
    .join('. ');
};
